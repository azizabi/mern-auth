				...
				{!isSubmitted ? (
					<form onSubmit={handleSubmit}>
						...
						<motion.button
							...
							whileTap={{ scale: 0.98 }}
							className='w-full py-3 px-4 bg-gradient-to-r from-yellow-500 to-pink-600 text-white font-bold rounded-lg shadow-lg hover:from-yellow-600 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200'
							type='submit'
						>
